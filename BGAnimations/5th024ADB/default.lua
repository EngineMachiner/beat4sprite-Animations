...
local path = beat4sprite.animationPath("5th024ABB")         local builder = loadfile(path)().Builder

local Spiral1 = beat4sprite.ActorFrame {
...
local Spiral2 = beat4sprite.ActorFrame {
...
return beat4sprite.BaseFrame {
    ...
    builder[1]:Load(), Spiral1, Spiral2,
