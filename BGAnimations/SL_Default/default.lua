...
-- Should have used Actor.RunCommandsRecursively() for all of this honestly.
...
local function meteor()
	...
	local m = beat4sprite.ActorFrame {
		...
		AnimateCommand=function(s)
			...
			s:stoptweening():zoom(0.6 + 0.5 * math.sqrt(math.random())):diffusealpha(1)
...
local t = beat4sprite.BaseFrame { Starlight.Background() }
